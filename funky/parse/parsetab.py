...
_lr_productions = [
  ...
  ('LEXP -> EXP IF EXP ELSE EXP','LEXP',5,'p_LEXP','funky_parser.py',232),
  ...
  ('PARAM -> IDENTIFIER','PARAM',1,'p_PARAM','funky_parser.py',380),
]
