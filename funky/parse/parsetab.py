...
_lr_productions = [
  ...
  ('MODULE_DEFINITION -> MODULE IDENTIFIER WITH BODY','MODULE_DEFINITION',4,'p_MODULE_DEFINITION','funky_parser.py',18),
  ...
  ('RHS -> EQUALS EXP WITH DECLARATIONS','RHS',4,'p_RHS','funky_parser.py',184),
  ('RHS -> GDRHS','RHS',1,'p_RHS','funky_parser.py',185),
  ('RHS -> GDRHS WITH DECLARATIONS','RHS',3,'p_RHS','funky_parser.py',186),
  ...
  ('MATCH_EXPR -> MATCH EXP ON OPEN_BRACE ALTS CLOSE_BRACE','MATCH_EXPR',6,'p_MATCH_EXPR','funky_parser.py',254),
  ...
  ('INFIX_FUNCTION -> TILDE IDENTIFIER TILDE','INFIX_FUNCTION',3,'p_INFIX_FUNCTION','funky_parser.py',335),
